...
public class CacheUtils {
    ...
    private  org.apache.logging.log4j.Logger LOG = LogManager.getLogger(LogManager.ROOT_LOGGER_NAME);

    private  RedisTemplate<String, Object> redisTemplate;
    private  StringRedisTemplate stringRedisTemplate;

    public CacheUtils(RedisTemplate<String, Object> redisTemplate, StringRedisTemplate stringRedisTemplate) {
